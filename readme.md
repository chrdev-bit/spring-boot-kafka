...
<p>
Visit http://localhost:8090/status.html (or 8091,8092 etc.) and you should see status updates of the cluster you're running.

Visit /chart.html to see real-time metrics for the Kafka connection.
